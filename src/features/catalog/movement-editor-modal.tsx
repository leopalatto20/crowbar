...
export function MovementEditorModal({
	...
	const isDirty = name !== initialForm.name
		|| groupDirty
					...
					<Box className="h-[92%] rounded-t-xl bg-background px-4 pb-4 pt-4 web:max-w-[800px] web:w-full web:mx-auto">
							...
							<Box className="gap-2">
								...
								{error && (
									<Box className="gap-2">
										...
										<Button variant="link" size="sm" className="self-start px-0" onPress={() => void save()}>
						...
						<Box className="gap-2 border-t border-border pt-4">
							{confirmingGroupChange ? (
								...
								<Box className="gap-2">
									<Button variant="outline" className="w-full" onPress={close} disabled={saving}><ButtonText>Cancel</ButtonText></Button>
