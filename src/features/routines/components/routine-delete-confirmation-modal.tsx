...
export function RoutineDeleteConfirmationModal({
  routine,
  onCancel,
  onConfirm,
        ...
        <Box className="w-full max-w-[480px] gap-4 rounded-xl bg-popover p-4">
          ...
          {routine && (
            <Text className="text-muted-foreground">
              Delete {routine.name} permanently? This cannot be undone.
            </Text>
          )}
          <Box className="flex-row justify-end gap-2">
            <Button
              variant="outline"
              onPress={onCancel}
              accessibilityLabel="Cancel Routine deletion"
            >
            ...
            <Button
              variant="destructive"
              onPress={onConfirm}
              accessibilityLabel="Confirm Routine deletion"
            >
