...
const buttonStyle = tva({
  ...
  variants: {
    variant: {
      ...
      outline:
        'border border-border bg-background shadow-xs data-[hover=true]:bg-accent data-[active=true]:bg-accent dark:bg-input/5 dark:border-border/90 dark:data-[hover=true]:bg-input/10 dark:data-[active=true]:bg-input/10',
      secondary:
